...
namespace AjisaiFlow.UnityAgent.Editor
{
    ...
    public static class AgentSettings
    {
        ...
        public static readonly HashSet<string> DefaultConfirmTools = new HashSet<string>
        {
            ...
            "RemoveVRCConstraint",
            "RemoveVRCPhysBone",
            "RemoveVRCPhysBoneCollider",
            "RemoveCollider",
            "RemoveComponent",
            "RemoveConstraint",
            "RemoveCustomBlendShape",
            "RemoveExpression",
            "RemoveVRCExpressionsMenuControl",
            "RemoveVRCExpressionParameter",
